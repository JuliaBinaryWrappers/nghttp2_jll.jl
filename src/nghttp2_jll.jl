...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import nghttp2_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("8e850ede-7688-5339-a07c-302acd2aaf8d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "nghttp2", artifacts_toml) for e in artifacts["nghttp2"]]
...
if best_platform === nothing
    @debug("Unable to load nghttp2; unsupported platform $(triplet(platform_key_abi()))")
else
